...
const CURRENT_CATEGORY_ID = "hockey";
...
export async function generateMetadata(
  ...
  const categoryName = categoryDetails.name; // Should be "NHL"
  ...
  const baseKeywords = ['live scores', 'results', 'news', 'schedule', 'updates', 'sportsurge', 'matches', 'fixtures', 'National Hockey League'];
