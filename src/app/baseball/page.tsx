...
const CURRENT_CATEGORY_ID = "baseball";
...
export async function generateMetadata(
  ...
  const categoryName = categoryDetails.name; // Should be "MLB"
  ...
  const baseKeywords = ['live scores', 'results', 'news', 'schedule', 'updates', 'sportsurge', 'matches', 'fixtures', 'Major League Baseball'];
